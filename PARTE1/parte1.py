...
def crear_Contactos(access_token):
	...
	NContactos = 0
	while NContactos < 10:
		nombre = "201403703_BEARER_No_" + str(NContactos)
...
if __name__ == '__main__':
	...
	access_token = GetToken('client_credentials', 'sa', 'fb5089840031449f1a4bf2c91c2bd2261d5b2f122bd8754ffe23be17b107b8eb103b441de3771745')
